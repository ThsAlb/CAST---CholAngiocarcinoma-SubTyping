...
## Model architecture
We used our established EfficientNET B3 pipeline (see our repository "HEPNET-Hepatic adenocarcinoma classification"). Training occured in a cross-validation manner with weights precalibrated to ImageNet. After transfer learning, we finetuned every layer according to our dataset.
